...
def on_open(ws):
    ...
    def do_create():
        ...
        params = {
            ...
            "frame": "0","game_label": "5","has_avatar": "1","map_id": "823355e702b39b643e0310f9b30e2873","map_name": "Back To School [2.0]","map_type": "41834052663740","map_version": "1781071464","max_count": "40","net_area": "0","net_isp": "0","net_status": "2","passwd": "","proxy_connected": "0","proxy_ip": "164.52.72.108","proxy_port": "51005","punch_ip": "164.52.28.134","punch_port": "60025","right": "1","room_name": "Back To School [2.0]","room_type": "5","s2t": str(int(time.time())),"thumbnail": "","time": str(int(time.time())),"token": "99e4f17ce52faaaaccc7dffecdb10c42","uicon": "2","uicon_box": "1","uin": "1321663876","uname": "#BDaxterr!","use_proxy": "0","version": "1.7.15","public_type": "0","prei_room_name_idx": "0","regapiid": "0",
        }
        try:
